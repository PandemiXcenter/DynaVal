...
# .github/workflows/ is to be configured by the user, not generated by this app.
```
...
build interface and expected outputs; workflow YAML is owned by the maintainer.
...
Ruff/mypy/pytest checks, run the shared packaging command,
...
No GitHub Actions workflow or public release is created here. The maintainer owns
the target runner matrix, signing, license decision, release notes and publication.
